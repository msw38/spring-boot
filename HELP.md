...
* The following dependency is not known to work with Spring Native: 'Spring Web Services'. As a result, your application
...
```
$ docker run --rm -p 8080:8080 spring-boot:0.0.1-SNAPSHOT
```
